		...
		<div class="content clearfix">
			<div id="top_content">
				...
				<ul class="subnav">
					...
					<li><a href="/trip/my-trips?past=true">Past Trips</a></li>
					<% if(UIHelper.isSupplierUser(loggedInUser)) { %>
					<% if(isPast) { %>
					<li><a href="/partner/my-bookings">Current Bookings</a></li>
					<li class="active">Past Bookings</li>
					<% } else { %>
					<li class="active">Current Bookings</li>
					<li class="active"><a href="/partner/my-bookings?past=true">Past Bookings</a></li>
					<% } %>
					<% } %>
				</ul>
				...
				%>
				<div class="deals">
					<h3 style="padding:25px 0 10px"><b><%=isPast ? "Past Bookings": "Pending Bookings"%></b></h3>
					<table class="table-striped" style="width:100%">
						...
						<tr>
							...
							<td class="options"><a href="/trip/trip-review?cnf=<%=trip.getReferenceId()%>">Manage Booking</a></td>
						</tr>
						<% } %>
					</table>
			...
			<div style="margin:4em 0;">
				...
				<% } else { %>
				<div class="u_alignC noDtBB dkC">
					<p>You haven't got any pending bookings.</p>
				</div>
				<% } %>
			</div>
			<% } %>
