...
<div class="deals" style="padding-left:10px;padding-top:15px">
	...
	<div class="full-width details" style="position:relative;">
		<div class="left" style="width:53%">
			...
			<% if (isLoggedIn && false) { %>
			<span style="display:inline-block"><a href="#" onclick="PKGSET.editItinerary(); return false;"><img src="http://images.tripfactory.com/static/img/poccom/edit-icon.png"></a></span>
			<% } %>
			</h1>
			<% if (hasValidConfiguration) { %>
			<span class="address"><%=PackageConfigManager.generateNightStayPackageDesc(pkgConfig)%></span>
			<% } %>
		</div>
		<div class="right actions" style="margin-right:15px">
			<div class="left">
				<a href="<%=Constants.SERVLET_B2C_MEMBER+"?action1=MYPACKAGES"%>" class="expand button rounded">Save</a>
			</div>
	...
	<div class="descriptions" style="color: #000;">
		This is a suggested overview of your travel plan. You can add/remove places or days to personalize further.
	</div>
	<div class="clearfix"></div>
</div>
<!--//inner navigation-->
<section class="three-fourth" style="width:100%;padding-left:10px">
	...
	<section id="advice" class="tab-content" style="width:100%">
		...
		<% } %>
		<% request.setAttribute(Attributes.WALL_ITEM_LIST.toString(), null); %>
